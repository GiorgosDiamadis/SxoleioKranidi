                    ...
                    <div className="flex space-x-7">
                        <div>
                            <a href="#" className="flex items-center py-4 px-2">
                                ...
                                <span className=" logo-text text-white text-lg">1ο Δημοτικό Σχολείο</span>
                            </a>
                        </div>
                        ...
                        <div className="hidden md:flex items-center space-x-1">
                            ...
                            <Link to={"/posts"}
                                  className={`py-4 px-2 ${history.location.pathname === "/posts" ? "text-blue-300" : "text-white "} hover:text-blue-300 ${history.location.pathname === "/posts" ? "border-b-4 border-blue-300" : ""} `}>
                                Ανακοινώσεις
                            </Link>
                            <Link to={"/contact"}
                                  className={`py-4 px-2 ${history.location.pathname === "/contact" ? "text-blue-300" : "text-white "} hover:text-blue-300 ${history.location.pathname === "/contact" ? "border-b-4 border-blue-300" : ""} `}>
                                Επικοινωνία
                            </Link>
                        </div>
                    </div>
                    ...
                    <div className="hidden md:flex items-center space-x-3 ">
                        {auth.user === null ? (
                            ...
                            <a onClick={() => auth.logout()}
                               className={`py-4 cursor-pointer px-2 ${history.location.pathname === "/login" ? "text-blue-300" : "text-white "} hover:text-blue-300 ${history.location.pathname === "/login" ? "border-b-4 border-blue-300" : ""} `}>
                                Αποσύνδεση
                            </a>
                        )}
                    </div>
