...
export default function Posts() {
    ...
    return (
        ...
        //                      className="w-4 h-4 -m-1 flex items-center text-red-500 mx-auto" fill="none"
        //                      viewBox="0 0 24 24" stroke="currentColor">
        //                     <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        //                           d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
        //                 </svg>
        //                 <svg xmlns="http://www.w3.org/2000/svg"
        //                      className="w-16 h-16 flex items-center text-red-500 mx-auto" viewBox="0 0 20 20"
        //                      fill="currentColor">
        ...
        //                 </button>
        //                 <button
        //                     className="mb-2 md:mb-0 bg-red-500 border border-red-500 px-5 py-2 text-sm shadow-sm font-medium tracking-wider text-white rounded-full hover:shadow-lg hover:bg-red-600">Delete
        //                 </button>
        //             </div>
        //         </div>
        //     </div>
